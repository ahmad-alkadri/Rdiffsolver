...
If we let the concentration from the side to diffuse into the slab for, let's say, $10^3 \ s$, what is the concentration profile in the $100^{th}$ second?
...
If we let the concentration from the side to diffuse into the slab for $1000 \ s$ tpo, what is the concentration profile in the $750^{th}$ second?
